  ...
  app().innerHTML = `
    <div class="wrap">
      <section class="page-hero">
        ...
        <p class="inline-cta">Want more TeenHQ? <a href="${APP_URL}" target="_blank" rel="noopener">Open the app →</a></p>
      </section>
...
function renderAdviceDetail(id){
  ...
  app().innerHTML = `
    <div class="wrap detail-wrap" style="padding:36px 0 20px;">
      ...
      <div class="cta-box"><p>Not sure how you're feeling today?</p><a href="${APP_URL}/mood" target="_blank" rel="noopener">Check My Mood</a></div>
      ${a.journal ? `
      <div class="journal-card">
        ...
        <div class="journal-foot"><span class="saved" id="journal-saved">saved ✓</span><a href="${APP_URL}" target="_blank" rel="noopener">Want to keep writing? Open My Journal →</a></div>
      </div>` : ''}
      ${others.length ? `
